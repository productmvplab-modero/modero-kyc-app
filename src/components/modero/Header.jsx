...
import { LogIn, LogOut, User, Settings, Globe, ChevronDown, LayoutGrid } from "lucide-react";
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="flex items-center gap-2 hover:opacity-80 transition-opacity">
                  <div className="rounded-full p-1 bg-gradient-to-br from-orange-500 via-amber-400 to-yellow-300 shadow-md shadow-orange-200/50">
                    <Avatar className="h-10 w-10 sm:h-11 sm:w-11 ring-2 ring-white">
