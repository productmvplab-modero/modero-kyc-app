...
export default function TenantDetailsDialog({ inquiry, open, onOpenChange, properties = [], onOpenProperty }) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-5xl max-h-[95vh] overflow-y-auto w-[95vw] sm:w-auto [&>button]:p-2 sm:[&>button]:p-3 [&>button]:rounded-lg sm:[&>button]:rounded-xl [&>button]:right-4 sm:[&>button]:right-6 [&>button]:top-5 sm:[&>button]:top-6 [&>button]:hover:bg-slate-100 [&>button>svg]:h-4 sm:[&>button>svg]:h-5 [&>button>svg]:w-4 sm:[&>button>svg]:w-5">
        <DialogHeader>
