                ...
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      <p className="text-sm font-medium text-slate-900 truncate">{inquiry.tenant_email}</p>
                      {inquiry.email_verified && <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />}
                    </div>
                  </div>
                </div>
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      <p className="text-sm font-medium text-slate-900 truncate">{inquiry.tenant_phone || '—'}</p>
                      {inquiry.mobile_verified && <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" />}
                    </div>
                  </div>
                </div>
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm font-medium text-slate-900 truncate">{inquiry.address || '—'}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 min-w-0">
                  <MapPin className="w-5 h-5 text-slate-400 shrink-0" />
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm font-medium text-slate-900 truncate">{inquiry.postal_code || '—'}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 min-w-0">
                  <MapPin className="w-5 h-5 text-slate-400 shrink-0" />
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm font-medium text-slate-900 truncate">{inquiry.city || '—'}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm font-medium text-slate-900 truncate">{inquiry.country || '—'}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 min-w-0">
                  <MapPin className="w-5 h-5 text-slate-400 shrink-0" />
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm font-medium text-slate-900 truncate">{inquiry.place_of_birth || '—'}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm font-medium text-slate-900 truncate">{inquiry.dni_nie_number || '—'}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 min-w-0">
              ...
              <CardContent className="px-3 sm:px-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  ...
                  <button
                    ...
                    className={`relative flex flex-col sm:flex-row items-start sm:items-center gap-3 p-3 sm:p-4 rounded-lg sm:rounded-xl border-2 transition-all text-left ${inquiry.recommended_financing === 'santander' ? 'border-red-500 bg-red-50 shadow-md' : 'border-slate-200 bg-white hover:border-red-300 hover:bg-red-50/50'}`}
                  >
