...
export default function ApartmentViewing() {
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-amber-50/30">
        ...
        <div className="py-8 px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-slate-600 mb-4">No application found</p>
            <Button variant="outline" onClick={() => setAdminMode(true)}>
  ...
  // Admin selection step
  if (adminMode && step === 'select') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-amber-50/30">
        <Header />
        <div className="p-6">
          <div className="max-w-4xl mx-auto">
            <div className="mb-8 flex items-center justify-between">
              <div>
                ...
                <p className="text-slate-600">Select application, date and time</p>
              </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex gap-3">
                  ...
                  <p className="text-sm text-blue-900">
                    A confirmation email will be sent to <strong>{adminInquiryData?.tenant_email}</strong>
                  </p>
                </div>
