    ...
    <div className="min-h-screen flex flex-col">
      ...
      <footer className="bg-gradient-to-r from-slate-900 via-indigo-900 to-purple-900 text-white py-12 mt-auto">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-slate-300">
                <li>
                  <a href="https://wa.me/1234567890" className="hover:text-white transition-colors flex items-center gap-2">
                ...
                <li>
                  <a href="mailto:support@modero.com" className="hover:text-white transition-colors flex items-center gap-2">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="border-t border-slate-700 mt-8 pt-8 flex flex-col md:flex-row justify-center items-center text-sm text-slate-400">
